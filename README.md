...
- The data folder is composed of different things : 
    - A lot scripts, coming of different sources, some are redundant (`scripts_imsdb` or `scripts_kaggle`). Special mention to The Internet Movie Script Database (IMSDb link), that provides a gigantic amount of movie scripts. 
